...
//working of ring when mouse enter on ring and tell us on which it is pointing
  const mouseInHandle = ()=>{
    var rot=0;
  ...
  // cleanups when mouse will leave
...
//this will change the screen when clicked on selected
const clickHandler=()=>{
  if(index===0){
    newScreen="Message";
   }
